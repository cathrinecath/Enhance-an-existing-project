...
describe('controller', function () {
	...
	describe('routing', function () {
		...
		it('should show completed entries', function () {
			// TODO: write test
			const todo = {title : 'my todo-list', completed: true};
			setUpModel([todo]);
	...
	describe('new todo', function () {
		it('should add a new todo to the model', function () {
			// TODO: write test
			var todo= {id: 42, title: 'My list', completed: false};

			setUpModel([todo]);

			subject.setView('');

			view.trigger('newTodo', 'a new list');

			expect(model.create).toHaveBeenCalledWith('a new list', jasmine.any(Function));
		});
